...
Create::Main()
{
  for(;;)
  {
	 ...
	 powerdata.charging = this->create_dev->charging_sources;
     ...
     irdata.ranges[11] = (float)this->create_dev->wall_signal; // wall IR signal
     irdata.ranges[12] = (float)this->create_dev->cliff_left_signal; // left IR signal
     irdata.ranges[13] = (float)this->create_dev->cliff_front_left_signal; // front left IR signal
     irdata.ranges[14] = (float)this->create_dev->cliff_front_right_signal; // front right IR signal
     irdata.ranges[15] = (float)this->create_dev->cliff_right_signal; // right IR signal
